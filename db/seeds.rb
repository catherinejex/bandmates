...
user5 = User.create!(email: "blackpumas@hello.com", password: "123456", username: "Black Pumas", bio: "We're an American psychedelic soul band based in Austin, Texas, led by singer/songwriter Eric Burton and guitarist/producer Adrian Quesada. We received our first Grammy Award nomination in 2020 for Best New Artist. We're looking for a female vocalist to join our group. ", location: "Austin, Texas", instrument_list: ["Vocals", "Guitar"], genre_list: ["Psychedelic soul", "R&B"], experience: "Professional" )
...
user7 = User.create!(email: "terry@hello.com", password: '123456', username: "Terry", bio: "Hi there, I'm Terry, and I'm learning how to play the drums! I've been playing for a few months now, but I would love any tips, tricks, or advice to improve. I live in NYC and love all types of music! I would also love to take my career to the next level and join a professional band.", location: "NYC, USA", instrument_list: ["Drums"], genre_list: ["Rock"], experience: "Novice")
user7.photos.attach(io: File.open('app/assets/images/terry.jpg'), filename: 'terry.jpg', content_type: 'image/jpeg')

user8 = User.create!(email: "raeesa@hello.com", password: "123456", username: "Raeesa Qureshi", bio: "I play the organ casually on the weekends when Im not coding or performing triple heart bypasses. I make fusion Brit-pop and soul, kinda snazzy", location: "Kent", instrument_list: ["Church Organ"], genre_list: ["Brit-pop", "Soul"], experience: "Intermediate" )
...
user10 = User.create!(email: "門脇@hello.com", password: '123456', username: '門脇 義雄', bio: "私はチーズケーキが大好きです。とても美味しいです。暑い日に素敵なチーズケーキとドクターペッパーに勝るものはありません", location: "Pleasant Valley, Mississipi", instrument_list: ['Steel Drums'], genre_list: ['Rap, Classical'], experience: "Professional")
...
user14 = User.create!(email: "cat@hello.com", password: '123456', username: 'Catherine', bio: "Hi there, I'm Catherine. I just moved back to the UK and looking to meet people with similar music taste as I. I've been playing bass (4 string) for about 3 years now.", location: "Kingston Upon Thames, UK", instrument_list: ["Bass"], genre_list: ['Death metal', "shoegaze", "Alternative"], experience: "Advanced")
user14.photos.attach(io: File.open('app/assets/images/cat.JPG'), filename: 'cat.JPG', content_type: 'image/JPG')

user15 = User.create!(email: "jlh@hello.com", password: '123456', username: 'Just Like Heaven', bio: "Just Like Heaven- an alternative rock group based in Birmingham, AL. Check us out on Spotify, Bandcamp, Facebook, and Instagram", location: "Alabama, USA", instrument_list: ["Vocals", "Lead guitar", "Rhythm guitar","Bass", "Drums"], genre_list: ["Alternative Rock"], experience: "Professional")
