...
user = User.create!(email: "1@hello.com", password: "123456", username: "drummerboy21", bio: "hey guys, i play the drums.", location: "Stoke Newington", instruments: ["drums", "triangle"], genres: ["funk"] )
user.photo.attach(io: File.open('app/assets/images/drummer.jpg'), filename: 'drummer.jpg', content_type: 'image/jpg')

user = User.create!(email: "2@hello.com", password: "123456", username: "guitarboy21", bio: "hey guys, i play the guitar.", location: "Los Angeles", instruments: ["guitar"], genres: ["punk", "grunge"] )
