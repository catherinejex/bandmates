...
post1 = Post.create!(description: "I've been listening to some really good throwbacks lately 🖤", location: 'Kingston Upon Thames, Greater London', youtube_link: "https://www.youtube.com/embed/6A1xu0BSs2s", user: user14, created_at: "2022-03-09 19:08:00")

post2 = Post.create!(description: "Are you looking for a producer? I can fully mix and master your music, £30/hour. Inquire for details", location: 'Houston, Texas', user: user13, created_at: "2022-03-07 19:08:00")
post2.photo.attach(io: File.open('app/assets/images/studio.jpg'), filename: 'studio.jpg', content_type: 'image/jpg')

post3 = Post.create!(description: "I'm now offering violin lessons for $20 an hour!", location: 'Kensington, London', user: user3, created_at: "2022-03-09 19:08:00")
post3.photo.attach(io: File.open('app/assets/images/Violin-Teacher.jpg'), filename: 'Violin-Teacher.jpg', content_type: 'image/jpg')

post4 = Post.create!(description: "Come see us play tonight at Slim Jim's! We will be opening for The Radio Dept. and we go on at 9pm!", location: "Angel, London", user: user7, created_at: "2022-03-07 19:08:00")
post4.photo.attach(io: File.open('app/assets/images/post4.jpg'), filename: 'post4.jpg', content_type: 'image/jpg')

post5 = Post.create!(description: "New music alert! Check out 'Catherine's Space Station' on Spotify and Bandcamp!", location: "Alabama, USA", spotify_link: "https://open.spotify.com/embed/track/7tK4NqOuGcdykYx5FemHyS?utm_source=generator", user: user15, created_at: "2022-03-09 19:08:00")

post6 = Post.create!(description: "Our new album 'Glow On' is out now on Spotify, iTunes, or wherever you get your music.", location: 'Baltimore, Maryland, USA', user: user1, created_at: "2022-03-08 19:08:00")
...
post7 = Post.create!(description: "Anyone remember this amazing performance?? Amazing!!", location: "Manchester, UK", youtube_link: "https://www.youtube.com/embed/6ayyfucIl6M", user: user16, created_at: "2022-03-04 19:08:00")

post8 = Post.create!(description: "If anyone is interested I have two tickets for this Saturday London Symphony Orchestra concert.", location: 'London, UK', user: user1, created_at: "2022-03-09 19:08:00")
post8.photo.attach(io: File.open('app/assets/images/orchestra1.jpeg'), filename: 'orchestra1.jpeg', content_type: 'image/jpeg')

post9 = Post.create!(description: "I had SO much fun at this concert my friend invited me to last night in London! Will definitely be looking for future dates!! 🎤", location: 'London, UK', user: user12, created_at: "2022-03-09 19:08:00")
post9.photo.attach(io: File.open('app/assets/images/post9.jpg'), filename: 'post9.jpg', content_type: 'image/jpg')

post10 = Post.create!(description: "Happy to announce that I'm now offering guitar lessons for £25/hour. I specialize in teaching beginners and novices and teaching the foundations of theory. Message me if interested!", location: "Clapham, London", user: user2, created_at: "2022-03-09 19:08:00")
...
post11 = Post.create!(description: "Thank you Birmingham, we had a wonderful time, catch us in Manchester next week!", location: 'Birmingham, UK', user: user10, created_at: "2022-03-08 19:08:00")
...
post12 = Post.create!(description: "Yo, criterion was lit last night, come see us at BOK center tmo", location: 'Oklahoma City, OK', user: user21, created_at: "2022-03-06 19:08:00")
post12.photo.attach(io: File.open('app/assets/images/rap-concer.jpeg'), filename: 'rap-concer.jpeg', content_type: 'image/jpeg')

post13 = Post.create!(description: "Basement never gets old. Hope they tour soon!", location: 'Kent', spotify_link: "https://open.spotify.com/embed/track/7n7LXkir2vxKrl7SSW4htc?utm_source=generator", user: user8, created_at: "2022-03-09 19:08:00")

post14 = Post.create!(description: "It's a Daft Punk kind of day 😎", location: 'London', spotify_link: "https://open.spotify.com/embed/track/2cGxRwrMyEAp8dEbuZaVv6?utm_source=generator", user: user20, created_at: "2022-03-09 19:08:00")

post15 = Post.create!(description: "I can't believe this came out in 2006! I feel old. 😲", location: 'NYC', youtube_link: "https://www.youtube.com/embed/z-mxBDuRaZ8", user: user7, created_at: "2022-03-09 19:08:00")
