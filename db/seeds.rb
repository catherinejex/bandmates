...
post = Post.create!(description: "Had a great time playing at CBGB's tonight! Off to Philadelphia next.", user: user1)
post.photo.attach(io: File.open('app/assets/images/srv.jpeg'), filename: 'srv.jpeg', content_type: 'image/jpeg')

post = Post.create!(description: "I'm now offering violin lessons for $20 an hour!", user: user2)
